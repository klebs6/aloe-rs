...
impl File {
    ...
    /**
      ...
      |
      */
    pub fn new_from_other(_0: &File) -> Self {
    ...
    /**
      ...
      |
      */
    pub fn assign_from(&mut self, new_absolute_path: &String) -> &mut File {
    ...
    /**
      ...
      |
      */
    pub fn assign_from(&mut self, other_file: &File) -> &mut File {
    ...
    /**
      ...
      |
      */
    pub fn get_relative_path_from(&self, directory_to_be_relative_to: &File) -> String {
    ...
    /**
      ...
      |
      */
    pub fn has_file_extension(&self, extension_to_test: &str) -> bool {
    ...
    /**
      ...
      |
      */
    pub fn get_child_file(&self, relative_or_absolute_path: &str) -> File {
    ...
    /**
      ...
      |
      */
    pub fn get_sibling_file(&self, sibling_file_name: &str) -> File {
    ...
    /**
      ...
      |
      */
    pub fn is_achild_of(&self, potential_parent_directory: &File) -> bool {
    ...
    /**
      ...
      |
      */
    pub fn get_nonexistent_child_file(&self, 
        prefix:                  &String,
        suffix:                  &String,
        put_numbers_in_brackets: bool) -> File {
    ...
    /**
      ...
      |
      */
    pub fn get_nonexistent_sibling(&self, put_numbers_in_brackets: bool) -> File {
        let put_numbers_in_brackets: bool = put_numbers_in_brackets.unwrap_or(true);
    ...
    /**
      ...
      |
      */
    pub fn set_last_modification_time(&self, new_time: Time) -> bool {
    ...
    /**
      ...
      |
      */
    pub fn set_last_access_time(&self, new_time: Time) -> bool {
    ...
    /**
      ...
      |
      */
    pub fn set_creation_time(&self, new_time: Time) -> bool {
    ...
    pub fn assign_from(&mut self, new_path: &String) -> &mut File {
    ...
    pub fn assign_from(&mut self, other: &File) -> &mut File {
    ...
    /**
      ...
      |
      */
    pub fn delete_recursively(&self, follow_symlinks: bool) -> bool {
    ...
    /**
      ...
      |
      */
    pub fn get_number_of_child_files(&self, 
        what_to_look_for:  i32,
        wild_card_pattern: &String) -> i32 {

        let wild_card_pattern: &String = wild_card_pattern.unwrap_or("*");
    ...
    /**
      ...
      |
      */
    pub fn create_output_stream(&self, buffer_size: usize) -> Box<FileOutputStream> {
    ...
    pub fn replace_with_text(
        ...
        line_feed:          Option<*const u8>) -> bool {
    ...
    /**
      ...
      |
      */
    pub fn create_symbolic_link(&mut self, 
...
impl File {
    ...
    pub fn get_special_location(&mut self, ty: SpecialLocationType) -> File {
...
impl File {
    ...
    #[cfg(target_os="linux")]
    pub fn copy_internal(&self, dest: &File) -> bool {
    ...
    #[cfg(target_os="linux")]
    pub fn find_file_system_roots(&mut self, dest_array: &mut Vec<File>)  {
...
impl File {
    ...
    pub fn get_special_location(&mut self, ty: SpecialLocationType) -> File {
            ...
            switch (type)
        {
            ...
            case invokedExecutableFile:
                if (aloe_argv != nullptr && aloe_argc > 0)
                    return File (CharPointer_UTF8 (aloe_argv[0]));
                // Falls through
                ALOE_FALLTHROUGH
            ...
            case hostApplicationPath:
            {
                ...
                return f.isSymbolicLink() ? f.getLinkedTarget() : aloe_getExecutableFile();
               #endif
            }
...
//-------------------------------------------[.cpp/Aloe/modules/aloe_core/native/aloe_linux_Files.cpp]
...
pub const U_ISOFS_SUPER_MAGIC: usize = 0x9660; // linux/iso_fs.h
pub const U_MSDOS_SUPER_MAGIC: usize = 0x4d44; // linux/msdos_fs.h
pub const U_NFS_SUPER_MAGIC:   usize = 0x6969; // linux/nfs_fs.h
pub const U_SMB_SUPER_MAGIC:   usize = 0x517B; // linux/smb_fs.h
...
#[cfg(target_os="linux")]
pub fn resolve_xdg_folder(
    ty:              *const u8,
    fallback_folder: *const u8) -> File {
...
#[cfg(target_os="linux")]
pub fn is_file_executable(filename: &String) -> bool {
    
    todo!();
    /*
        aloe_statStruct info;

        return aloe_stat (filename, info)
