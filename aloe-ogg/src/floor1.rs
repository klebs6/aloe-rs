...
//-------------------------------------------[.cpp/Aloe/modules/aloe_audio_formats/codecs/oggvorbis/libvorbis-1.3.7/lib/floor1.c]

/**
   floor 1 fixed at -140dB to 0dB range
  */
pub const FLOOR1_RANGEDb: usize = 140;
...
pub fn floor1_free_info(i: *mut VorbisInfoFloor)  {
...
pub fn floor1_free_look(i: *mut VorbisLookFloor)  {
...
pub fn floor1_look(
        ...
        in_: *mut VorbisInfoFloor) -> *mut VorbisLookFloor {
...
pub fn vorbis_db_quant(x: *const f32) -> i32 {
...
/**
   the floor has already been filtered to only
...
pub fn floor1_fit(
        vb:      *mut VorbisBlock,
        look:    *mut VorbisLookFloor1,
        logmdct: *const f32,
        logmask: *const f32) -> *mut i32 {
...
pub fn floor1_encode(
        opb:      *mut OggPackBuffer,
        vb:       *mut VorbisBlock,
        look:     *mut VorbisLookFloor1,
        post:     *mut i32,
        ilogmask: *mut i32) -> i32 {
...
pub fn floor1_inverse1(
        vb:  *mut VorbisBlock,
        in_: *mut VorbisLookFloor)  {
