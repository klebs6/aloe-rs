/*!
 function: simple programmatic interface for
 encoder mode setup
*/

crate::ix!();

//-------------------------------------------[.cpp/Aloe/modules/aloe_audio_formats/codecs/oggvorbis/libvorbis-1.3.7/lib/vorbisenc.c]

/**
  | careful with this; it's using static
  | array sizing to make managing all the
  | modes a little less annoying. If we use
  | a residue backend with > 12 partition
  | types, or a different division of iteration,
  | this needs to be updated.
  |
  */
pub struct StaticBookBlock {
    books: [[*const StaticCodebook; 12]; 4],
}

pub struct VorbisResidueTemplate {
    ...
    grouping:           i32,
    res:                *const VorbisInfoResidue0,
    book_aux:           *const StaticCodebook,
    book_aux_managed:   *const StaticCodebook,
    books_base:         *const StaticBookBlock,
    books_base_managed: *const StaticBookBlock,
}

pub struct VorbisMappingTemplate<'a> {
    map: *const VorbisInfoMapping0<'a>,
    res: *const VorbisResidueTemplate,
}
...
/**
  ...
  | for setting things up step-by-step
  | with the detailed vorbis_encode_ctl
  | interface.
  | 
  | There's a fair amount of redundancy
  | such that interactive setup does not
  | directly deal with any vorbis_info
  | or codec_setup_info initialization;
  | it's all stored (until full init) in
  | this highlevel setup, then flushed
  | out to the real codec setup structs later.
  |
  */
pub struct Att3 {
...
pub struct AdjStereo {
    ...
    k_hz:        [f32; PACKETBLOBS],
    lowpassk_hz: [f32; PACKETBLOBS],
}
...
pub struct Noise3 {
    data: [[i32; P_NOISECURVES]; 17],
}

pub struct VeSetupDataTemplate<'a> {
    mappings:                        i32,
    rate_mapping:                    *const f64,
    quality_mapping:                 *const f64,
    coupling_restriction:            i32,
    samplerate_min_restriction:      i64,
    samplerate_max_restriction:      i64,
    blocksize_short:                 *const i32,
    blocksize_long:                  *const i32,
    psy_tone_masteratt:              *const Att3,
    psy_tone_0db:                    *const i32,
    psy_tone_d_bsuppress:            *const i32,
    psy_tone_adj_impulse:            *const VpAdjBlock,
    psy_tone_adj_long:               *const VpAdjBlock,
    psy_tone_adj_other:              *const VpAdjBlock,
    psy_noiseguards:                 *const NoiseGuard,
    psy_noise_bias_impulse:          *const Noise3,
    psy_noise_bias_padding:          *const Noise3,
    psy_noise_bias_trans:            *const Noise3,
    psy_noise_bias_long:             *const Noise3,
    psy_noise_d_bsuppress:           *const i32,
    psy_noise_compand:               *const CompandBlock,
    psy_noise_compand_short_mapping: *const f64,
    psy_noise_compand_long_mapping:  *const f64,
    psy_noise_normal_start:          [*const i32; 2],
    psy_noise_normal_partition:      [*const i32; 2],
    psy_noise_normal_thresh:         *const f64,
    psy_ath_float:                   *const i32,
    psy_ath_abs:                     *const i32,
    psy_lowpass:                     *const f64,
    global_params:                   *const VorbisInfoPsyGlobal,
    global_mapping:                  *const f64,
    stereo_modes:                    *const AdjStereo,
    floor_books:                     *const *const *const StaticCodebook,
    floor_params:                    *const VorbisInfoFloor1,
    floor_mappings:                  i32,
    floor_mapping_list:              *const *const i32,
    maps:                            *const VorbisMappingTemplate<'a>,
}
...
/**
  ...
  |
  */
pub const mode_template: [VorbisInfoMode; 2] = [
    VorbisInfoMode { blockflag: 0, windowtype: 0, transformtype: 0, mapping: 0 },
    VorbisInfoMode { blockflag: 1, windowtype: 0, transformtype: 0, mapping: 1 },
];

pub const MAP_NOMINAL: &[VorbisInfoMapping0] = &[
    VorbisInfoMapping0 { 
        submaps:         1, 
        chmuxlist:      &[0,0], 
        floorsubmap:    &[0], 
...
pub fn vorbis_encode_floor_setup(
        vi:    *mut VorbisInfo,
        s:     i32,
        books: *const *const *const StaticCodebook,
        in_:   *const VorbisInfoFloor1,
        x:     *const i32)  {
...
pub fn vorbis_encode_global_psych_setup(
        vi:  *mut VorbisInfo,
        s:   f64,
        in_: *const VorbisInfoPsyGlobal,
        x:   *const f64)  {
...
pub fn vorbis_encode_global_stereo(
        vi: *mut VorbisInfo,
        hi: *const HighLevelEncodeSetup,
        p:  *const AdjStereo)  {
...
pub fn vorbis_encode_psyset_setup(
        vi:           *mut VorbisInfo,
        s:            f64,
        nn_start:     *const i32,
        nn_partition: *const i32,
        nn_thresh:    *const f64,
        block:        i32)  {
...
pub fn vorbis_encode_tonemask_setup(
        vi:    *mut VorbisInfo,
        s:     f64,
        block: i32,
        att:   *const Att3,
        max:   *const i32,
        in_:   *const VpAdjBlock)  {
...
pub fn vorbis_encode_compand_setup(
        vi:    *mut VorbisInfo,
        s:     f64,
        block: i32,
        in_:   *const CompandBlock,
        x:     *const f64)  {
...
pub fn vorbis_encode_peak_setup(
        vi:       *mut VorbisInfo,
        s:        f64,
        block:    i32,
        suppress: *const i32)  {
...
pub fn vorbis_encode_noisebias_setup(
        vi:       *mut VorbisInfo,
        s:        f64,
        block:    i32,
        suppress: *const i32,
        in_:      *const Noise3,
        guard:    *const NoiseGuard,
        userbias: f64)  {
...
pub fn vorbis_encode_ath_setup(
        vi:    *mut VorbisInfo,
        block: i32)  {
...
pub fn book_dup_or_new(
        ci:   *mut CodecSetupInfo,
        book: *const StaticCodebook) -> i32 {
...
pub fn vorbis_encode_blocksize_setup(
        vi:     *mut VorbisInfo,
        s:      f64,
        shortb: *const i32,
        longb:  *const i32)  {
...
pub fn vorbis_encode_residue_setup(
        vi:     *mut VorbisInfo,
        number: i32,
        block:  i32,
        res:    *const VorbisResidueTemplate)  {
...
/**
  ...
  |
  */
pub fn vorbis_encode_map_n_res_setup(
        vi:   *mut VorbisInfo,
        s:    f64,
        maps: *const VorbisMappingTemplate)  {
...
pub fn setting_to_approx_bitrate(vi: *mut VorbisInfo) -> f64 {
...
pub fn get_setup_template(
        ch:           i64,
        srate:        i64,
        req:          f64,
        q_or_bitrate: i32,
        base_setting: *mut f64)  {
...
/**
  | encoders will need to use vorbis_info_init
  | beforehand and call vorbis_info clear
  | when all done
  | 
  | two interfaces; this, more detailed
  | one, and later a convenience layer on
  | top
  |
  | the final setup call
  |
  */
pub fn vorbis_encode_setup_init(vi: *mut VorbisInfo) -> i32 {
...
pub fn vorbis_encode_setup_setting(
        vi:       *mut VorbisInfo,
        channels: i64,
        rate:     i64)  {
