...
//-------------------------------------------[.cpp/Aloe/modules/aloe_audio_formats/codecs/oggvorbis/libvorbis-1.3.7/lib/modes/psych_8.h]
...
pub const PSY_LOWPASS_8: [f64; 3] = [3.0,4.0,4.0];

pub const NOISE_START_8: [i32; 2] = [
  64,64,
];

pub const NOISE_PART_8: [i32; 2] = [
  8,8,
];

pub const PSY_ATH_FLOATER_8: [i32; 3] = [
  -100,-100,-105,
];

pub const PSY_ATH_ABS_8: [i32; 3] = [
  -130,-130,-140,
];
