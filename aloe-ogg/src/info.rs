/*!
  | function: maintain the info structure,
  | info <-> header packets
  |
  */
crate::ix!();

//-------------------------------------------[.cpp/Aloe/modules/aloe_audio_formats/codecs/oggvorbis/libvorbis-1.3.7/lib/info.c]

/**
  | general handling of the header and the
  | vorbis_info structure (and substructures)
  |
  */
pub const GENERAL_VENDOR_STRING: &'static str = "Xiph.Org libVorbis 1.3.7";
pub const ENCODE_VENDOR_STRING:  &'static str = "Xiph.Org libVorbis I 20200704 (Reducing Environment)";
...
pub fn vorbis_comment_init(vc: *mut VorbisComment)  {
...
/** 
 | This is more or less the same as strncasecmp
 | - but that doesn't exist everywhere, and this
 | is a fairly trivial function, so we include it
 */
pub fn tagcompare(
        s1: *const u8,
        s2: *const u8,
...
pub fn vorbis_comment_clear(vc: *mut VorbisComment)  {
...
/**
  | blocksize 0 is guaranteed to be short,
  | 1 is guaranteed to be long. They may be
  | equal, but short will never ge greater
  | than long
  */
...
/** 
  ...
  */
pub fn vorbis_info_init(vi: *mut VorbisInfo)  {
...
pub fn vorbis_info_clear(vi: *mut VorbisInfo)  {
...
/**
  | all of the real encoding details are
  | here. The modes, books, everything
  */
pub fn vorbis_unpack_books(
        vi:  *mut VorbisInfo,
        opb: *mut OggPackBuffer) -> i32 {
...
/** 
  ...
  */
pub fn vorbis_synthesis_idheader(op: *mut OggPacket) -> i32 {
...
/** 
   The Vorbis header is in three packets; the
   initial small packet in the first page that
   identifies basic parameters, a second packet with
   bitstream comments and a third packet that holds
   the codebook. 
   */
...
/* pack side **********************************************************/
pub fn vorbis_pack_info(
        opb: *mut OggPackBuffer,
        vi:  *mut VorbisInfo) -> i32 {
...
pub fn vorbis_pack_comment(
        opb: *mut OggPackBuffer,
        vc:  *mut VorbisComment) -> i32 {
...
pub fn vorbis_analysis_headerout(
        v:       *mut VorbisDspState,
        vc:      *mut VorbisComment,
        op:      *mut OggPacket,
        op_comm: *mut OggPacket,
        op_code: *mut OggPacket) -> i32 {
...
pub fn vorbis_version_string() -> *const u8 {
