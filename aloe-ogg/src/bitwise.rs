/*!
  | function: packing variable sized words
...
//-------------------------------------------[.cpp/Aloe/modules/aloe_audio_formats/codecs/oggvorbis/bitwise.c]

/* 
   We're 'LSb' endian; if we write a word but read
   individual bits, then we'll read the lsb first 
   */

pub const BUFFER_INCREMENT: usize = 256;
...
pub const MASK8B: &[u32] = &[
    0x00,0x80,0xc0,0xe0,0xf0,0xf8,0xfc,0xfe,0xff
];

pub fn oggpack_writeinit(b: *mut OggPackBuffer)  {
...
pub fn oggpackb_writeinit(b: *mut OggPackBuffer)  {
...
pub fn oggpack_writecheck(b: *mut OggPackBuffer) -> i32 {
...
pub fn oggpackb_writecheck(b: *mut OggPackBuffer) -> i32 {
...
pub fn oggpack_writealign(b: *mut OggPackBuffer)  {
...
pub fn oggpackb_writealign(b: *mut OggPackBuffer)  {
...
pub fn oggpack_writecopy_helper(
        b:      *mut OggPackBuffer,
        source: *mut c_void,
        bits:   i64,
        w:      fn(
...
pub fn oggpack_reset(b: *mut OggPackBuffer)  {
...
pub fn oggpackb_reset(b: *mut OggPackBuffer)  {
...
pub fn oggpack_look1(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpackb_look1(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpack_read1(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpackb_read1(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpack_bytes(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpack_bits(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpackb_bytes(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpackb_bits(b: *mut OggPackBuffer) -> i64 {
...
pub fn oggpack_get_buffer(b: *mut OggPackBuffer) -> *mut u8 {
...
pub fn oggpackb_get_buffer(b: *mut OggPackBuffer) -> *mut u8 {
...
/**
 Self test of the bitwise routines; everything
 else is based on them, so they damned well better
 be solid. 
 */
#[test] fn oggvorbis_test_bitwise_routines() {

    pub fn ilog(v: u32) -> i32 {
