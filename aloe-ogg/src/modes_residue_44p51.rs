/*!
 function: toplevel residue templates for
 32/44.1/48kHz uncoupled
*/

crate::ix!();

//-------------------------------------------[.cpp/Aloe/modules/aloe_audio_formats/codecs/oggvorbis/libvorbis-1.3.7/lib/modes/residue_44p51.h]
