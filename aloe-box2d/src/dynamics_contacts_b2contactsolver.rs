...
pub const B2_DEBUG_SOLVER: usize = 0;

//-------------------------------------------[.cpp/Aloe/modules/aloe_box2d/box2d/Dynamics/Contacts/b2ContactSolver.h]

pub struct b2VelocityConstraintPoint
{
    ra:              b2Vec2,
    rb:              b2Vec2,
    normal_impulse:  f32,
...
pub struct b2ContactVelocityConstraint
{
    points:        [b2VelocityConstraintPoint; b2_maxManifoldPoints],
    normal:        b2Vec2,
    normal_mass:   b2Mat22,
    k:             b2Mat22,
    indexa:        i32,
...
///-----------------------
pub struct b2ContactSolver {
    step:                 b2TimeStep,
    positions:            *mut b2Position,
    velocities:           *mut b2Velocity,
    allocator:            *mut b2StackAllocator,
    position_constraints: *mut b2ContactPositionConstraint,
    velocity_constraints: *mut b2ContactVelocityConstraint,
    contacts:             *mut *mut b2Contact,
    count:                i32,
}

impl Drop for b2ContactSolver {
    fn drop(&mut self) {
        todo!();
        /* 
...
impl b2ContactSolver {
    ...
    pub fn new(def: *mut b2ContactSolverDef) -> Self {
    ...
    /**
       Initialize position dependent portions of
    ...
    /**
       Sequential position solver for position
       constraints.
      */
    pub fn solve_toi_position_constraints(&mut self, 
        toi_indexa: i32,
        toi_indexb: i32) -> bool {
...
//-------------------------------------------[.cpp/Aloe/modules/aloe_box2d/box2d/Dynamics/Contacts/b2ContactSolver.cpp]
pub struct b2ContactPositionConstraint
{
    local_points:  [b2Vec2; b2_maxManifoldPoints],
    local_normal:  b2Vec2,
    local_point:   b2Vec2,
    indexa:        i32,
    indexb:        i32,
...
///------------------
pub struct b2PositionSolverManifold {
    normal:     b2Vec2,
    point:      b2Vec2,
    separation: f32,
}
...
impl b2PositionSolverManifold {
    ...
    pub fn initialize(&mut self, 
        pc:    *mut b2ContactPositionConstraint,
        xfa:   &b2Transform,
        xfb:   &b2Transform,
        index: i32)  {
