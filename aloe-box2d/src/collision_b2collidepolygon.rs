...
//-------------------------------------------[.cpp/Aloe/modules/aloe_box2d/box2d/Collision/b2CollidePolygon.cpp]

/**
   Find the separation between poly1 and poly2 for
   a give edge normal on poly1.
  */
pub fn b2edge_separation(
        poly1: *const b2PolygonShape,
        xf1:   &b2Transform,
        edge1: i32,
        poly2: *const b2PolygonShape,
        xf2:   &b2Transform) -> f32 {
...
/**
   Find the max separation between poly1 and poly2
   using edge normals from poly1.
  */
pub fn b2find_max_separation(
        edge_index: *mut i32,
        poly1:      *const b2PolygonShape,
        xf1:        &b2Transform,
        poly2:      *const b2PolygonShape,
...
/*
  | Find edge normal of max separation on
  | A - return if separating axis is found
  |
  | Find edge normal of max separation on
  | B - return if separation axis is found
  |
...
pub fn b2collide_polygons(
        ...
        polya:    *const b2PolygonShape,
        xfa:      &b2Transform,
        polyb:    *const b2PolygonShape,
        xfb:      &b2Transform)  {
