...
//-------------------------------------------[.cpp/Aloe/examples/DemoRunner/Builds/Android/app/src/main/assets/Box2DTests/Car.h]

/**
   This is a fun demo that shows off the wheel
   joint
  */
pub struct Car {
    base:    Test,
    ...
    zeta:    f32,
    speed:   f32,
    spring1: *mut b2WheelJoint,
    spring2: *mut b2WheelJoint,
}
