...
//-------------------------------------------[.cpp/Aloe/examples/DemoRunner/Builds/Android/app/src/main/assets/Box2DTests/DumpShell.h]

/**
   This test holds worlds dumped using
   b2World::Dump.
  */
pub struct DumpShell {
    base: Test,
}

impl Default for DumpShell {
