...
//-------------------------------------------[.cpp/Aloe/examples/Assets/Box2DTests/PolyShapes.h]

pub const K_MAX_BODIES: usize = 256;
...
impl b2QueryCallback for PolyShapesCallback {
    ...
    /**
      ...
      | query AABB. @return false to terminate the
      | query.
      |
      */
...
pub struct PolyShapes {
    base:       Test,
    body_index: i32,
    bodies:     *mut [b2Body; K_MAX_BODIES],
...
impl PolyShapes {
    ...
    pub fn create(&mut self, index: i32)  {
        ...
        /*
            ...
            m_bodyIndex = (m_bodyIndex + 1) % K_MAX_BODIES;
        */
    }
    ...
    pub fn destroy_body(&mut self)  {
        ...
        todo!();
        /*
            for (int32 i = 0; i < K_MAX_BODIES; ++i)
            {
                if (m_bodies[i] != NULL)
                {
    ...
    pub fn keyboard(&mut self, key: u8)  {
        ...
        /*
            ...
            case 'a':
                for (int32 i = 0; i < K_MAX_BODIES; i += 2)
                {
                    if (m_bodies[i])
                    {
