...
//-------------------------------------------[.cpp/Aloe/modules/aloe_box2d/box2d/Collision/b2CollideEdge.cpp]
...
/**
  | This holds polygon B expressed in frame
  | A.
  |
  */
pub struct b2TempPolygon
{
...
pub enum B2EpColliderVertexType
{
    e_isolated,
    e_concave,
    e_convex
...
/**
  | This class collides and edge and a polygon,
  | taking into account edge adjacency.
  |
  */
pub struct b2EPCollider {
    polygonb:    b2TempPolygon,
    xf:          b2Transform,
    centroidb:   b2Vec2,
    v0:          b2Vec2,
    v1:          b2Vec2,
    ...
    normal2:     b2Vec2,
    normal:      b2Vec2,
    type1:       B2EpColliderVertexType,
    type2:       B2EpColliderVertexType,
    lower_limit: b2Vec2,
    upper_limit: b2Vec2,
    radius:      f32,
    front:       bool,
...
/**
  ...
  |
  | 4. Initialize normal range to [-pi, pi] about
  | face normal
  |
  | 5. Adjust normal range according to adjacent
  | edges
  |
  | 6. Visit each separating axes, only accept axes
  | within the range
  |
...
impl b2EPCollider {
    ...
    pub fn compute_edge_separation(&mut self) -> b2EPAxis {
    ...
    pub fn compute_polygon_separation(&mut self) -> b2EPAxis {
