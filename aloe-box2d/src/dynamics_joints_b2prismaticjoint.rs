...
//-------------------------------------------[.cpp/Aloe/modules/aloe_box2d/box2d/Dynamics/Joints/b2PrismaticJoint.h]

/**
  | Prismatic joint definition. This requires
  | defining a line of motion using an axis and an
  | anchor point. The definition uses local anchor
  | points and a local axis so that the initial
...
pub struct b2PrismaticJointDef {
    ...
    /**
      The lower translation limit, usually in
      meters.
      */
    lower_translation: f32,

    /**
      The upper translation limit, usually in
      meters.
      */
...
impl Default for b2PrismaticJointDef {
...
impl b2PrismaticJointDef {

    /**
      | Initialize the bodies, anchors, axis,
      | and reference angle using the world
...
/**
  | A prismatic joint. This joint provides one
  | degree of freedom: translation along an axis
  | fixed in bodyA. Relative rotation is
  | prevented. You can use a joint limit to
  | restrict the range of motion and a joint motor
  | to drive the motion or to model joint
  | friction.
  */
...
//-------------------------------------------[.cpp/Aloe/modules/aloe_box2d/box2d/Dynamics/Joints/b2PrismaticJoint.cpp]
impl b2PrismaticJoint {
    ...
    /**
      | Get the motor speed, usually in meters
      | per second.
      |
      */
    ...
    pub fn new(def: *const b2PrismaticJointDef) -> Self {
    ...
    /**
      ...
      ----------------------
      | Block Solver
      | We develop a block solver that includes the
      | joint limit. This makes the limit stiff
      | (inelastic) even when the mass has poor
      | distribution (leading to large torques about
      | the joint anchor points).
      |
      ----------------------
    ...
    /**
      | Get the lower joint limit, usually in
      | meters.
      |
      */
    ...
    /**
      | Get the upper joint limit, usually in
      | meters.
      |
      */
    ...
    /**
      | Set the motor speed, usually in meters
      | per second.
      |
      */
    ...
    /**
      | Set the maximum motor force, usually
      | in N.
      |
      */
    ...
    /**
      | Get the current motor force given the
      | inverse time step, usually in N.
      |
      */
