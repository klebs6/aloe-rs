...
//-------------------------------------------[.cpp/Aloe/modules/aloe_graphics/image_formats/jpglib/jfdctint.c]
...
pub mod dct_islow_supported {
    ...
    /**
      ...
      | 
      | Each 1-D DCT step produces outputs which
      | are a factor of sqrt(N) larger than the
      | true DCT outputs. The final outputs
      | are therefore a factor of N larger than
      | desired; since N=8 this can be cured
      | by a simple right shift at the end of the
      | algorithm. The advantage of this arrangement
      | is that we save two multiplications
      | per 1-D DCT, because the y0 and y4 outputs
      | need not be divided by sqrt(N).
      | 
      | In the IJG code, this factor of 8 is removed
      | by the quantization step (in jcdctmgr.c),
      | NOT in this module.
      | 
      ...
      | (thus retaining
      | 
      | CONST_BITS bits of precision in the
      | constants). After doing a multiplication
      ...
      | (For 12-bit sample data, the intermediate
      | array is i32 anyway.)
      | 
    ...
    /**
      ...
      |
      */
    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_0_298631336 {
        () => {
            /*
                    ((i32)  2446)    /* FIX(0.298631336) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_0_390180644 {
        () => {
            /*
                    ((i32)  3196)    /* FIX(0.390180644) */
            */
        }
    }
    ...
    macro_rules! fix_0_541196100 {
        () => {
            /*
                    ((i32)  4433)    /* FIX(0.541196100) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_0_765366865 {
        () => {
            /*
                    ((i32)  6270)    /* FIX(0.765366865) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_0_899976223 {
        () => {
            /*
                    ((i32)  7373)    /* FIX(0.899976223) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_1_175875602 {
        () => {
            /*
                    ((i32)  9633)    /* FIX(1.175875602) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_1_501321110 {
        () => {
            /*
                    ((i32)  12299)   /* FIX(1.501321110) */
            */
        }
    }
    ...
    macro_rules! fix_1_847759065 {
        () => {
            /*
                    ((i32)  15137)   /* FIX(1.847759065) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_1_961570560 {
        () => {
            /*
                    ((i32)  16069)   /* FIX(1.961570560) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_2_053119869 {
        () => {
            /*
                    ((i32)  16819)   /* FIX(2.053119869) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_2_562915447 {
        () => {
            /*
                    ((i32)  20995)   /* FIX(2.562915447) */
            */
        }
    }

    #[cfg(CONST_BITS_EQ_13)]
    macro_rules! fix_3_072711026 {
        () => {
            /*
                    ((i32)  25172)   /* FIX(3.072711026) */
            */
        }
    }

    #[cfg(not(CONST_BITS_EQ_13))]
    macro_rules! fix_0_298631336 {
        () => {
            /*
                    FIX(0.298631336)
