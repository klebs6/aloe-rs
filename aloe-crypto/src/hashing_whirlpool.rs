...
//-------------------------------------------[.cpp/Aloe/modules/aloe_cryptography/hashing/aloe_Whirlpool.h]

/**
  | Whirlpool hash class.
  | 
  | The Whirlpool algorithm was developed
  | by <a href="mailto:pbarreto@scopus.com.br">Paulo
  | S. L. M. Barreto</a> and <a href="mailto:vincent.rijmen@cryptomathic.com">Vincent
  | Rijmen</a>.
  | 
  | See P.S.L.M. Barreto, V. Rijmen, "The
  | Whirlpool hashing function" NESSIE
  | submission, 2000 (tweaked version,
  | 2001), https://www.cosic.esat.kuleuven.ac.be/nessie/workshop/submissions/whirlpool.zip
  | 
  | @see SHA256, MD5
  | 
  | @tags{Cryptography}
...
impl PartialEq<Whirlpool> for Whirlpool {
    
    #[inline] fn eq(&self, other: &Whirlpool) -> bool {
        todo!();
        /*
...
impl Whirlpool {
    ...
    /**
      ...
      |
      */
    pub fn new_from_whirlpool(other: &Whirlpool) -> Self {
    ...
    /**
      ...
      |
      */
    pub fn assign_from(&mut self, other: &Whirlpool) -> &mut Whirlpool {
    ...
    /**
      ...
      | E.g. @code Whirlpool checksum (myString.toUTF8());
      | @endcode
      |
      */
    ...
    /**
      | Returns the hash as a 64-byte block of
      | data.
      |
      */
    ...
    /**
      | Returns the checksum as a 128-digit
      | hex string.
      |
      */
...
//-------------------------------------------[.cpp/Aloe/modules/aloe_cryptography/hashing/aloe_Whirlpool.cpp]

pub struct WhirlpoolProcessor {
    bit_length:  [u8; 32],
    buffer:      [u8; 64],
    buffer_bits: i32, // default = 0
    buffer_pos:  i32, // default = 0
    hash:        [u64; 8],
}

impl Default for WhirlpoolProcessor {
    fn default() -> Self {
        todo!();
    }
}

impl WhirlpoolProcessor {
    ...
    pub fn finalize(&mut self, result: *mut u8)  {
    ...
    pub fn process_next_buffer(&mut self)  {
