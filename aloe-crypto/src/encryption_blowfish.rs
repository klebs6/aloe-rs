...
//-------------------------------------------[.cpp/Aloe/modules/aloe_cryptography/encryption/aloe_BlowFish.h]
...
//-------------------------------------------[.cpp/Aloe/modules/aloe_cryptography/encryption/aloe_BlowFish.cpp]
impl BlowFish {

    /**
      | Creates an object that can encode/decode
    ...
    /**
      ...
      |
      */
    pub fn new_from_other(other: &BlowFish) -> Self {
    ...
    /**
      ...
      |
      */
    pub fn assign_from(&mut self, other: &BlowFish) -> &mut BlowFish {
    ...
    /**
      ...
      |
      */
    pub fn encrypt_memory_block(&self, data: &mut MemoryBlock)  {
    ...
    /**
      ...
      |
      */
    pub fn decrypt_memory_block(&self, data: &mut MemoryBlock)  {
    ...
    /**
      ...
      | See bufferSize on size requirements!
      | ----------
      | @param sizeOfMsg
      | 
      | The size of the message that should be
      | encrypted in bytes
      | ----------
      | @param bufferSize
      | 
      | The size of the buffer in bytes. To accommodate
      | the encrypted data, the buffer must
      | be larger than the message: the size
      | of the buffer needs to be equal or greater
      | than the size of the message in bytes
      | rounded to the next integer which is
      | divisible by eight. If the message size
      | in bytes is already divisible by eight
      | then you need to add eight bytes to the
      | buffer size. If in doubt simply use bufferSize
      | = sizeOfMsg + 8.
      | 
      | -----------
      | @return
