...
//-------------------------------------------[.cpp/Aloe/examples/Assets/AudioLiveScrollingDisplay.h]

/** 
   | This component scrolls a continuous waveform
   | showing the audio that's coming into whatever
   | audio inputs this object is connected to.
   */
#[no_copy]
#[leak_detector]
