...
pub fn resize_image_to_power_of_two(image: Image) -> Image {
...
pub fn opengl_utils_get_presets() -> Vec<OpenGLAppDemoShaderPreset> {
    ...
    /*
        ...
        return Vec<ShaderPreset> (presets, numElementsInArray (presets));
    */
}
